...
(function (window) {
            ...
            homeDiv.innerHTML = `
                <div class="home_container">
                    ...
                    <p>
                        ...
                        I care about you <span class="green">babe</span>, that's I made this <br/>
                        I need you <span class="green">babe</span>, I'm fear to loose you forever, you're so funny <br/>
                        Anyway, that was my fault <br/>,
                        I'll hope for your answer :)
                    </p>
    ...
    navigationLink.click(nav => {
        ...
        if ($(this).hasClass('out')) {
            window.open('http://instagram.com/sndydh_');
        } else {
            createHome();
        }
    });
    ...
    const opts = {
        bubu: document.getElementById('bubu.jpg'),
        ...
        piyela: document.getElementById('piyela.jpg'),
    }
